...
const ComingUp: React.FC = () => {
  ...
  // Check if we have real upcoming tracks
  const hasRealTracks = nextUpData?.next_tracks && nextUpData.next_tracks.length > 0
  const upcomingTracks = hasRealTracks ? nextUpData.next_tracks : []
